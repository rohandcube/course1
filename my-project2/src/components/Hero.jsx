    ...
    <section className="bg-gray-500 text-white py-8 px-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div className="flex justify-center">
          <img src="https://i.ibb.co/Vm8ntjB/2pic1.png" alt="Makeup Artist" className="border-4 border-primary"/>
        </div>
        <div>
          <h1 className="text-3xl font-bold mb-4 text-primary">Advanced Hair Style Cutting</h1>
